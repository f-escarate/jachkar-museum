...
[BurstCompile]
public class AutoGSAsset: MonoBehaviour
{
    ...
    static ColorFormat m_FormatColor;
    static bool m_ImportCameras = true;

    static unsafe void GenerateGSplatAsset(){
        string[] arguments = Environment.GetCommandLineArgs();
        string m_InputFile = arguments[9];
        Debug.Log("~~~ Creating asset ~~~: " + m_InputFile);
    ...
    static unsafe NativeArray<InputSplatData> LoadPLYSplatFile(string plyPath)
    {
    ...
    static void CreateColorData(NativeArray<InputSplatData> inputSplats, string filePath, ref Hash128 dataHash, out int width, out int height, out GraphicsFormat format)
    {
...
struct CreateOtherDataJob : IJobParallelFor
{
    ...
    public unsafe void Execute(int index)
    {
        ...
        // rotation: 4 bytes
        {
            ...
            uint enc = CreatePositionsDataJob.EncodeQuatToNorm10(rot);
            *(uint*) outputPtr = enc;
            outputPtr += 4;
        }

        // scale: 6, 4 or 2 bytes
        CreatePositionsDataJob.EmitEncodedVector(m_Input[index].scale, outputPtr, m_ScaleFormat);
                ...
                case GaussianSplatAsset.SHFormat.Norm11:
                    {
                        ...
                        res.sh1 = CreatePositionsDataJob.EncodeFloat3ToNorm11(splat.sh1);
                        res.sh2 = CreatePositionsDataJob.EncodeFloat3ToNorm11(splat.sh2);
                        res.sh3 = CreatePositionsDataJob.EncodeFloat3ToNorm11(splat.sh3);
                        res.sh4 = CreatePositionsDataJob.EncodeFloat3ToNorm11(splat.sh4);
                        res.sh5 = CreatePositionsDataJob.EncodeFloat3ToNorm11(splat.sh5);
                        res.sh6 = CreatePositionsDataJob.EncodeFloat3ToNorm11(splat.sh6);
                        res.sh7 = CreatePositionsDataJob.EncodeFloat3ToNorm11(splat.sh7);
                        res.sh8 = CreatePositionsDataJob.EncodeFloat3ToNorm11(splat.sh8);
                        res.sh9 = CreatePositionsDataJob.EncodeFloat3ToNorm11(splat.sh9);
                        res.shA = CreatePositionsDataJob.EncodeFloat3ToNorm11(splat.shA);
                        res.shB = CreatePositionsDataJob.EncodeFloat3ToNorm11(splat.shB);
                        res.shC = CreatePositionsDataJob.EncodeFloat3ToNorm11(splat.shC);
                        res.shD = CreatePositionsDataJob.EncodeFloat3ToNorm11(splat.shD);
                        res.shE = CreatePositionsDataJob.EncodeFloat3ToNorm11(splat.shE);
                        res.shF = CreatePositionsDataJob.EncodeFloat3ToNorm11(splat.shF);
                ...
                case GaussianSplatAsset.SHFormat.Norm6:
                    {
                        ...
                        res.sh1 = CreatePositionsDataJob.EncodeFloat3ToNorm565(splat.sh1);
                        res.sh2 = CreatePositionsDataJob.EncodeFloat3ToNorm565(splat.sh2);
                        res.sh3 = CreatePositionsDataJob.EncodeFloat3ToNorm565(splat.sh3);
                        res.sh4 = CreatePositionsDataJob.EncodeFloat3ToNorm565(splat.sh4);
                        res.sh5 = CreatePositionsDataJob.EncodeFloat3ToNorm565(splat.sh5);
                        res.sh6 = CreatePositionsDataJob.EncodeFloat3ToNorm565(splat.sh6);
                        res.sh7 = CreatePositionsDataJob.EncodeFloat3ToNorm565(splat.sh7);
                        res.sh8 = CreatePositionsDataJob.EncodeFloat3ToNorm565(splat.sh8);
                        res.sh9 = CreatePositionsDataJob.EncodeFloat3ToNorm565(splat.sh9);
                        res.shA = CreatePositionsDataJob.EncodeFloat3ToNorm565(splat.shA);
                        res.shB = CreatePositionsDataJob.EncodeFloat3ToNorm565(splat.shB);
                        res.shC = CreatePositionsDataJob.EncodeFloat3ToNorm565(splat.shC);
                        res.shD = CreatePositionsDataJob.EncodeFloat3ToNorm565(splat.shD);
                        res.shE = CreatePositionsDataJob.EncodeFloat3ToNorm565(splat.shE);
                        res.shF = CreatePositionsDataJob.EncodeFloat3ToNorm565(splat.shF);
                        res.shPadding = default;
